...
<body>
    ...
    <div id="form-container">
        <form method="POST" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
            ...
            <input type="text" name="nome" id="nome" style="border-color: black; border-width: 2px;">
            <select name="nome_academia" id="nome_academia" style="width: 842px; border-width: 2px; border-color: black; height: 45px; border-radius: 5px;">
